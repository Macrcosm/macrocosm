...
const RightPanel: FC<RightPanelProps> = (props) => {
    ...
    return (
        <div
            className="bg-black-chip/60 w-[328px] divide-y divide-grey-800 flex flex-col h-[calc(100vh-78px)] overflow-y-auto text-sm">
            <div className="p-5">
                ...
                <div className="flex gap-8 mt-2.5">
                    ...
                    <button className="flex gap-1.5 items-center"
                            onClick={() => navigator.clipboard.writeText(props.mainIdea)}>
                        Copy
                        <BiCopy size={18}/>
                    </button>
                </div>
