...
const Dropdown: FC<DropdownProps> = (props) => {
    const {options, selectedOption, setSelectedOption, description, trigger} = props;
    ...
    return (
        ...
        >
            ...
            <Listbox.Options
                className="absolute mt-2 z-10 bg-black-chip  ring-1 ring-border rounded-xl text-sm child:px-5 child:py-2 py-2">
                {description && (
